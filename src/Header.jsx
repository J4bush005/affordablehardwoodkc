    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto d-flex">
        ...
        <li class="nav-item dropdown mx-3">
          ...
          <ul class="dropdown-menu">
            <li><Link to="/Gallery" class="nav-link under" role="button"  aria-expanded="false">Before and After</Link></li>
            <li><Link to="/Gallery" class="nav-link under" role="button"  aria-expanded="false">Custom Designs</Link></li>
            <li><Link to="/Gallery" class="nav-link under" role="button"  aria-expanded="false">Luxury Vinyl Tiles</Link></li>
            <li><Link to="/Gallery" class="nav-link under" role="button" aria-expanded="false">Classic Hardwood</Link></li>
            <li><Link to="/Gallery" class="nav-link under" role="button" aria-expanded="false">Stairs</Link></li>
            <li><Link to="/Gallery" class="nav-link under" role="button" aria-expanded="false">Commercial Jobs</Link></li>
          </ul>
        </li>
         <li class="nav-item dropdown mx-3">
          ...
          <ul class="dropdown-menu">
            ...
            <li><Link to="/Services" class="nav-link under" role="button" aria-expanded="false">Repairs</Link></li>
         ...
         <li class="nav-item dropdown last mx-3">
          ...
          <ul class="dropdown-menu">
            ...
            <li><Link to="/Contact" class="nav-link under" role="button" aria-expanded="false">Contact Us</Link></li>
            <li><Link to="/Contact" class="nav-link under" role="button" aria-expanded="false">Online Payment</Link></li>
          </ul>
        </li>
      </ul>
      </div>
